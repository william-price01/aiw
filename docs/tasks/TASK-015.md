...
- Happy-path flow:
  ...
  7. On PASS → log, transition PLANNED, terminate.
...
- Emits: state_transition, test_run_started, test_run_passed, run_complete.
...
- Full trace event emission for happy path events.
